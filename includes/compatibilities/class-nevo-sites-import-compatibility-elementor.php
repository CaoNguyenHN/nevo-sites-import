 ...
 */
class Nevo_Sites_Import_Compatibility_Elementor {

	/**
	 * Singleton instance
	 *
	 * @var Nevo_Sites_Import_Compatibility_Elementor
	 */
	 ...
	 *
	 * @return Nevo_Sites_Import_Compatibility_Elementor
	 */
	...
	protected function __construct() {
		 ...
		 * since Elementor 3.5
		 */
		add_action( 'nevo/sites_import/before_import_contents', array( $this, 'delete_auto_generated_kit' ) );
	}
...
Nevo_Sites_Import_Compatibility_Elementor::instance();
