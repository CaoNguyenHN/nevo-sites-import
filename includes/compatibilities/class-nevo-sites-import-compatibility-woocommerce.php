 ...
 */
class Nevo_Sites_Import_Compatibility_WooCommerce {

	/**
	 * Singleton instance
	 *
	 * @var Nevo_Sites_Import_Compatibility_WooCommerce
	 */
	 ...
	 *
	 * @return Nevo_Sites_Import_Compatibility_WooCommerce
	 */
	...
	protected function __construct() {
		...
		add_action( 'nevo/sites_import/prepare_import', array( $this, 'import_product_attributes' ) );
	}
...
Nevo_Sites_Import_Compatibility_WooCommerce::instance();
